    ...
    return (
        <>
            ...
            <div className={classes.aboutBody}>
                ...
                🌞
                <p>I graduated in 2019 with my Bachelors in I.T. at Florida International University 
                    but had a focus in a software developement track.</p>
                <p>I've had an interest in web development for some time,
                    ...
                    and made a cute site of my favorite things for my class project!</p>
                <a href='https://ocelot.aul.fiu.edu/~vcani003/index.html'>Link to class project</a>
                <p>Nowadays, you can catch me doing some neat frontend stuff with React, Redux, and other cool techs. 🤓 
                    I currently work on developing features and creating high fidelity prototypes @ JPMC.</p>

                <p>Currently I'm located in Tampa and live with my fiancé and our beautiful kitty gals 
                    Lumi, Luci and sometimes Coco. We love food and dream of traveling southeast asia 
                    and finding the best eats out there.</p>
